<template>
  <div class="module-page">
    <h1>hr_payroll::add_attendance()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>add_attendance()</code></td></tr>
        <tr><td>Original view</td><td><code>views/add_attendance.php</code></td></tr>
...
export default {
  ...
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/add_attendance');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
