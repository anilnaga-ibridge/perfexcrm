  ...
  <div class="module-page">
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>manage_bonus()</code></td></tr>
        <tr><td>Original view</td><td><code>views/manage_bonus.php</code></td></tr>
...
export default {
  ...
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/manage_bonus');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
