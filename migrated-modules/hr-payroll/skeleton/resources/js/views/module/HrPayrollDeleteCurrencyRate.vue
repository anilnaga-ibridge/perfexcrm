<template>
  <div class="module-page">
    <h1>hr_payroll::delete_currency_rate()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>delete_currency_rate()</code></td></tr>
        <tr><td>Original view</td><td><code>views/delete_currency_rate.php</code></td></tr>
...
export default {
  name: 'HrPayrollDeleteCurrencyRate',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/delete_currency_rate');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
