<template>
  <div class="module-page">
    <h1>hr_payroll::data_integration()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>data_integration()</code></td></tr>
        <tr><td>Original view</td><td><code>views/data_integration.php</code></td></tr>
...
export default {
  ...
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/data_integration');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
