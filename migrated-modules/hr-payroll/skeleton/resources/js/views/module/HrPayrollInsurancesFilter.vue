<template>
  <div class="module-page">
    <h1>hr_payroll::insurances_filter()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>insurances_filter()</code></td></tr>
        <tr><td>Original view</td><td><code>views/insurances_filter.php</code></td></tr>
...
export default {
  name: 'HrPayrollInsurancesFilter',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/insurances_filter');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
