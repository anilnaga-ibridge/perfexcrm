<template>
  <div class="module-page">
    <h1>hr_payroll::staff_id_changed()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>staff_id_changed()</code></td></tr>
        <tr><td>Original view</td><td><code>views/staff_id_changed.php</code></td></tr>
...
export default {
  ...
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/staff_id_changed');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
