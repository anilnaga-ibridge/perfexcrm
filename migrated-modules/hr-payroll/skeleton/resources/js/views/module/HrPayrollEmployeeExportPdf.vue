<template>
  <div class="module-page">
    <h1>hr_payroll::employee_export_pdf()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>employee_export_pdf()</code></td></tr>
        <tr><td>Original view</td><td><code>views/employee_export_pdf.php</code></td></tr>
...
export default {
  name: 'HrPayrollEmployeeExportPdf',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/employee_export_pdf');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
