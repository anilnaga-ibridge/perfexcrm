<template>
  <div class="module-page">
    <h1>hr_payroll::add_manage_employees()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>add_manage_employees()</code></td></tr>
        <tr><td>Original view</td><td><code>views/add_manage_employees.php</code></td></tr>
...
export default {
  name: 'HrPayrollAddManageEmployees',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/add_manage_employees');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
