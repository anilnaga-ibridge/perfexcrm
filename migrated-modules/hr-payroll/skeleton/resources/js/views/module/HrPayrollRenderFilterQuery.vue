<template>
  <div class="module-page">
    <h1>hr_payroll::render_filter_query()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>render_filter_query()</code></td></tr>
        <tr><td>Original view</td><td><code>views/render_filter_query.php</code></td></tr>
...
export default {
  name: 'HrPayrollRenderFilterQuery',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/render_filter_query');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
