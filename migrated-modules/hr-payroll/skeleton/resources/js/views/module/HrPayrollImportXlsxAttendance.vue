<template>
  <div class="module-page">
    <h1>hr_payroll::import_xlsx_attendance()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>import_xlsx_attendance()</code></td></tr>
        <tr><td>Original view</td><td><code>views/import_xlsx_attendance.php</code></td></tr>
...
export default {
  name: 'HrPayrollImportXlsxAttendance',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/import_xlsx_attendance');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
