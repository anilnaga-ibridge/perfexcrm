<template>
  <div class="module-page">
    <h1>hr_payroll::view_payslip_detail()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>view_payslip_detail()</code></td></tr>
        <tr><td>Original view</td><td><code>views/view_payslip_detail.php</code></td></tr>
...
export default {
  name: 'HrPayrollViewPayslipDetail',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/view_payslip_detail');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
