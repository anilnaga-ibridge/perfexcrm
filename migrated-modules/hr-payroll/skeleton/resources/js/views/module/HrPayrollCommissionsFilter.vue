<template>
  <div class="module-page">
    <h1>hr_payroll::commissions_filter()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>commissions_filter()</code></td></tr>
        <tr><td>Original view</td><td><code>views/commissions_filter.php</code></td></tr>
...
export default {
  name: 'HrPayrollCommissionsFilter',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/commissions_filter');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
