<template>
  <div class="module-page">
    <h1>hr_payroll::income_taxs_filter()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>income_taxs_filter()</code></td></tr>
        <tr><td>Original view</td><td><code>views/income_taxs_filter.php</code></td></tr>
...
export default {
  name: 'HrPayrollIncomeTaxsFilter',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/income_taxs_filter');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
