<template>
  <div class="module-page">
    <h1>hr_payroll::attendance_filter()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>attendance_filter()</code></td></tr>
        <tr><td>Original view</td><td><code>views/attendance_filter.php</code></td></tr>
...
export default {
  name: 'HrPayrollAttendanceFilter',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/attendance_filter');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
