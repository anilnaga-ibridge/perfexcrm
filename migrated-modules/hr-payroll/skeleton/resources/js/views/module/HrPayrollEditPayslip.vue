  ...
  <div class="module-page">
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>edit_payslip()</code></td></tr>
        <tr><td>Original view</td><td><code>views/edit_payslip.php</code></td></tr>
...
export default {
  ...
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/edit_payslip');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
