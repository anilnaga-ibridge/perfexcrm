<template>
  <div class="module-page">
    <h1>hr_payroll::setting_incometax_rates()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>setting_incometax_rates()</code></td></tr>
        <tr><td>Original view</td><td><code>views/setting_incometax_rates.php</code></td></tr>
...
export default {
  name: 'HrPayrollSettingIncometaxRates',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/setting_incometax_rates');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
