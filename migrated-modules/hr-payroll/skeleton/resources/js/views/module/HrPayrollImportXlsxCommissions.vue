<template>
  <div class="module-page">
    <h1>hr_payroll::import_xlsx_commissions()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>import_xlsx_commissions()</code></td></tr>
        <tr><td>Original view</td><td><code>views/import_xlsx_commissions.php</code></td></tr>
...
export default {
  name: 'HrPayrollImportXlsxCommissions',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/import_xlsx_commissions');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
