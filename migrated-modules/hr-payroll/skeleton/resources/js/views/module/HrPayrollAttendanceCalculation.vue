<template>
  <div class="module-page">
    <h1>hr_payroll::attendance_calculation()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>attendance_calculation()</code></td></tr>
        <tr><td>Original view</td><td><code>views/attendance_calculation.php</code></td></tr>
...
export default {
  name: 'HrPayrollAttendanceCalculation',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/attendance_calculation');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
