<template>
  <div class="module-page">
    <h1>hr_payroll::setting_insurance_list()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>setting_insurance_list()</code></td></tr>
        <tr><td>Original view</td><td><code>views/setting_insurance_list.php</code></td></tr>
...
export default {
  name: 'HrPayrollSettingInsuranceList',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/setting_insurance_list');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
