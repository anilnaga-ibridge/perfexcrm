<template>
  <div class="module-page">
    <h1>hr_payroll::import_attendance_excel()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>import_attendance_excel()</code></td></tr>
        <tr><td>Original view</td><td><code>views/import_attendance_excel.php</code></td></tr>
...
export default {
  name: 'HrPayrollImportAttendanceExcel',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/import_attendance_excel');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
