<template>
  <div class="module-page">
    <h1>Gtsverify::activate()</h1>
    <p class="migration-badge">🚧 Manual Migration Required</p>

    <div class="migration-context">
      <table>
        <tr><td>Original controller</td><td><code>Gtsverify.php</code> extends <code>AdminController</code></td></tr>
        <tr><td>Original method</td><td><code>activate()</code></td></tr>
        <tr><td>Original view</td><td><code>views/activate.php</code></td></tr>
...
export default {
  ...
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/activate');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
