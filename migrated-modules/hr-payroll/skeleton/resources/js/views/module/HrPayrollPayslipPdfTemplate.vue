<template>
  <div class="module-page">
    <h1>hr_payroll::payslip_pdf_template()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>payslip_pdf_template()</code></td></tr>
        <tr><td>Original view</td><td><code>views/payslip_pdf_template.php</code></td></tr>
...
export default {
  name: 'HrPayrollPayslipPdfTemplate',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/payslip_pdf_template');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
