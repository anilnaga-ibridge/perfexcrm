<template>
  <div class="module-page">
    <h1>hr_payroll::manage_employees()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>manage_employees()</code></td></tr>
        <tr><td>Original view</td><td><code>views/manage_employees.php</code></td></tr>
...
export default {
  ...
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/manage_employees');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
