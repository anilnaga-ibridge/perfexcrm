<template>
  <div class="module-page">
    <h1>hr_payroll::delete_payslip_template()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>delete_payslip_template()</code></td></tr>
        <tr><td>Original view</td><td><code>views/delete_payslip_template.php</code></td></tr>
...
export default {
  name: 'HrPayrollDeletePayslipTemplate',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/delete_payslip_template');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
