<template>
  <div class="module-page">
    <h1>hr_payroll::save_pdf_payslip_data()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>save_pdf_payslip_data()</code></td></tr>
        <tr><td>Original view</td><td><code>views/save_pdf_payslip_data.php</code></td></tr>
...
export default {
  name: 'HrPayrollSavePdfPayslipData',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/save_pdf_payslip_data');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
