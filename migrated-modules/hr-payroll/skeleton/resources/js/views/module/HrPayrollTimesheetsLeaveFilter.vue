<template>
  <div class="module-page">
    <h1>hr_payroll::timesheets_leave_filter()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>timesheets_leave_filter()</code></td></tr>
        <tr><td>Original view</td><td><code>views/timesheets_leave_filter.php</code></td></tr>
...
export default {
  name: 'HrPayrollTimesheetsLeaveFilter',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/timesheets_leave_filter');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
