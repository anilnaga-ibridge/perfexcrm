<template>
  <div class="module-page">
    <h1>hr_payroll::add_timesheets_leave()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>add_timesheets_leave()</code></td></tr>
        <tr><td>Original view</td><td><code>views/add_timesheets_leave.php</code></td></tr>
...
export default {
  name: 'HrPayrollAddTimesheetsLeave',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/add_timesheets_leave');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
