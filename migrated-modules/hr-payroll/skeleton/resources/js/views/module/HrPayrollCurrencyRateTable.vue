<template>
  <div class="module-page">
    <h1>hr_payroll::currency_rate_table()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>currency_rate_table()</code></td></tr>
        <tr><td>Original view</td><td><code>views/currency_rate_table.php</code></td></tr>
...
export default {
  name: 'HrPayrollCurrencyRateTable',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/currency_rate_table');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
