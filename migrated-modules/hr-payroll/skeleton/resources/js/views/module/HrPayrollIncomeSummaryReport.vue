<template>
  <div class="module-page">
    <h1>hr_payroll::income_summary_report()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>income_summary_report()</code></td></tr>
        <tr><td>Original view</td><td><code>views/income_summary_report.php</code></td></tr>
...
export default {
  name: 'HrPayrollIncomeSummaryReport',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/income_summary_report');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
