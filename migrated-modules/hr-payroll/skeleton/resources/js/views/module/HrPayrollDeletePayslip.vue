<template>
  <div class="module-page">
    <h1>hr_payroll::delete_payslip()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>delete_payslip()</code></td></tr>
        <tr><td>Original view</td><td><code>views/delete_payslip.php</code></td></tr>
...
export default {
  ...
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/delete_payslip');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
