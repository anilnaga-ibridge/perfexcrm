<template>
  <div class="module-page">
    <h1>hr_payroll::permission_modal()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>permission_modal()</code></td></tr>
        <tr><td>Original view</td><td><code>views/permission_modal.php</code></td></tr>
...
export default {
  ...
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/permission_modal');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
