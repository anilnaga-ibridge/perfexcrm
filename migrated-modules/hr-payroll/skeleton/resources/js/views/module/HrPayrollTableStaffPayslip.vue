<template>
  <div class="module-page">
    <h1>hr_payroll::table_staff_payslip()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>table_staff_payslip()</code></td></tr>
        <tr><td>Original view</td><td><code>views/table_staff_payslip.php</code></td></tr>
...
export default {
  name: 'HrPayrollTableStaffPayslip',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/table_staff_payslip');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
