<template>
  <div class="module-page">
    <h1>hr_payroll::bonus_kpi_filter()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>bonus_kpi_filter()</code></td></tr>
        <tr><td>Original view</td><td><code>views/bonus_kpi_filter.php</code></td></tr>
...
export default {
  ...
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/bonus_kpi_filter');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
