<template>
  <div class="module-page">
    <h1>hr_payroll::get_payroll_column()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>get_payroll_column()</code></td></tr>
        <tr><td>Original view</td><td><code>views/get_payroll_column.php</code></td></tr>
...
export default {
  name: 'HrPayrollGetPayrollColumn',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/get_payroll_column');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
