<template>
  <div class="module-page">
    <h1>hr_payroll::payslip_template_table()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>payslip_template_table()</code></td></tr>
        <tr><td>Original view</td><td><code>views/payslip_template_table.php</code></td></tr>
...
export default {
  name: 'HrPayrollPayslipTemplateTable',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/payslip_template_table');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
