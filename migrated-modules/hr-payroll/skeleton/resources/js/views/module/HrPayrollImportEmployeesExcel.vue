<template>
  <div class="module-page">
    <h1>hr_payroll::import_employees_excel()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>import_employees_excel()</code></td></tr>
        <tr><td>Original view</td><td><code>views/import_employees_excel.php</code></td></tr>
...
export default {
  name: 'HrPayrollImportEmployeesExcel',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/import_employees_excel');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
