<template>
  <div class="module-page">
    <h1>hr_payroll::employees_copy()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>employees_copy()</code></td></tr>
        <tr><td>Original view</td><td><code>views/employees_copy.php</code></td></tr>
...
export default {
  ...
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/employees_copy');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
