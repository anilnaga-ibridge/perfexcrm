<template>
  <div class="module-page">
    <h1>hr_payroll::create_payslip_file()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>create_payslip_file()</code></td></tr>
        <tr><td>Original view</td><td><code>views/create_payslip_file.php</code></td></tr>
...
export default {
  name: 'HrPayrollCreatePayslipFile',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/create_payslip_file');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
