<template>
  <div class="module-page">
    <h1>hr_payroll::manage_commissions()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>manage_commissions()</code></td></tr>
        <tr><td>Original view</td><td><code>views/manage_commissions.php</code></td></tr>
...
export default {
  name: 'HrPayrollManageCommissions',
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/manage_commissions');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
