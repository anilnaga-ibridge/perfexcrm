<template>
  <div class="module-page">
    <h1>hr_payroll::get_currency_rate()</h1>
    ...
    <div class="migration-context">
      <table>
        ...
        <tr><td>Original method</td><td><code>get_currency_rate()</code></td></tr>
        <tr><td>Original view</td><td><code>views/get_currency_rate.php</code></td></tr>
...
export default {
  ...
  setup() {
    ...
    const fetchData = async () => {
      loading.value = true;
      try {
        const response = await axios.get('/api/module/get_currency_rate');
        // Handle response
      } catch (err) {
        console.error(err);
      } finally {
